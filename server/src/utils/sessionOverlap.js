...
export function holdEnd(start, windowEnd, durationMinutes = HOLD_MINUTES) {
...
export function preferredStartsInWindow(windowStart, windowEnd, taken, durationMinutes) {
