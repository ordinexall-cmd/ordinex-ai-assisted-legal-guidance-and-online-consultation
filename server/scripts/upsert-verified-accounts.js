...
async function upsertCitizen() {
  ...
  const data = {
    ...
    bio: 'Fully verified Ordinex citizen account with complete Philippine domicile and ID proof on file.',
    // Trust score / booking unlock (100 ID proof) requires avatar + emergency + ID artifacts.
...
async function upsertLawyer() {
  ...
  const data = {
    ...
    bio: 'Fully verified Philippine Bar counsel for Ordinex production use with complete KYC and practice profile.',
    yearsOfExperience: 6,
    ...
    avatarUrl: '/uploads/avatars/demo-lawyer.jpg',
    isVerified: true,
