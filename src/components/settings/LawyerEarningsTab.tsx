...
import { PaymentDestinationForm } from '../payment/PaymentDestinationForm';
import {
  bankComplete,
  ewalletComplete,
  ...
  return (
    <div className="settings-editor panel-rich">
      <div className="wallet-prototype-note" role="note">
        ...
        <p>
          Citizens pay each booking through Ordinex checkout (PayMongo — e-wallet or bank transfer).
          After a completed consultation with no issues, 85% is credited to your wallet below and
          15% is the platform fee. Withdraw to the e-wallet or bank account you save below.
        </p>
      </div>
      ...
      <PaymentDestinationForm
        ...
        description="Where Ordinex sends your withdrawals. Saved for payout only — never shown on your public directory."
        idPrefix="earnings"
        saveLabel="Save payout destination"
      />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
            ...
            <div className="form-field">
              ...
              <select
                ...
                disabled={!hasDestination}
              >
                <option value="GCASH" disabled={!hasEwallet}>E-wallet{hasEwallet ? '' : ' (not saved)'}</option>
